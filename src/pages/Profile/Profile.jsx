...
export function Profile() {
  const { profileModal, setProfileModal } = useData();
  const [editModal, setEditModal] = useState(false);
  return (
    <div className={`profile-container w-2/4  md:w-full md:mx-4`}>
      <div className="flex items-center">
        <i className="text-md fa-solid fa-arrow-left cursor-pointer" />
        <p className="text-md font-semibold ml-8">Rutvik Umak</p>
      </div>
      <div
      ...
      >
        ...
        <div className="grow">
          <div className="flex justify-between mb-2">
            ...
            <button className="px-2 py-1 rounded-md font-semibold text-gray-500 hover:bg-gray-100  ring-1 ring-gray-500 ring-inset self-start" onClick={()=>setProfileModal(true)}>
              Edit Profile
            </button>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl flex">
          ...
          <div className="post-container px-4 grow">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="rounded-full px-3 py-0.5 bg-gray-200 cursor-pointer relative">
                <i className="text-sm fa-solid fa-ellipsis-vertical opacity-60" />{" "}
                <ul className="dropdown absolute m-0 text-sm px-1 py-2 rounded-lg top-8 right-4 bg-white w-36 gap-1">
                  <li className="hover:bg-slate-200 flex items-center  px-3 py-1 rounded-lg">
                    <i className="fa-regular fa-pen-to-square mr-2 " />
        ...
        <div className="bg-white p-4 rounded-xl flex">
          ...
          <div className="post-container px-4 grow">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="rounded-full px-3 py-0.5 bg-gray-200 cursor-pointer">
                <i className="text-sm fa-solid fa-ellipsis-vertical opacity-60" />
              </div>
            </div>
            <div>
